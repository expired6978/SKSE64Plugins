...
bool TRIFile::Apply(BSGeometry * geometry, BSFixedString morphName, float relative)
{
...
SInt32 MorphHandler::LoadSliders(tArray<RaceMenuSlider> * sliderArray, RaceMenuSlider * slider)
{
	PlayerCharacter * player = (*g_thePlayer);
